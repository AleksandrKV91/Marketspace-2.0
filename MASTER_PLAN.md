...
### D2. Расширенные фильтры в FilterBar (по вкладкам) ✅ ЧАСТИЧНО (07.04.2026)

**OrderTab** ✅:
- [x] Горизонт заказа: 30д | 60д | 90д (влияет на расчёт в API)
- [x] Статус: Все | Критический | Внимание | Норма
- [x] ABC: Все | A | B | C

**PriceTab** — Δ CTR/CR/CPM/CPC фильтры — в очереди  
**AnalyticsTab** — Δ выручки/маржи — в очереди  
**NicheTab** — категория/месяц — в очереди
